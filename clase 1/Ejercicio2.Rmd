...
archivo=paste0(dir_ds, "/","usu_individual_T122.txt.txt")
tiempo_read_table <- system.time({
individualt120 <- read.table(archivo, sep = ";", header = TRUE)
})
...
saveRDS(individualt120, file=glue("{dir_ds}/individualt120.rds"))
tiempo_readRDS <- system.time({
individualt120 <- readRDS(file=glue("{dir_ds}/individualt120.rds"))
})
